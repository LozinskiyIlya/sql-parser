...
public class SourceParserIT extends AbstractSpringParserTest {
    ...
    class TableSource {
        ...
        void oneTable() throws Exception {
            ...
            assertSourceEquals(Table.class, "some_table", parsed.getSources().getFirst());
        }
        ...
        void implicitCrossJoin() throws Exception {
            ...
            assertSourceEquals(Table.class, "some_table", parsed.getSources().get(0));
            assertSourceEquals(Table.class, "one_more_t", parsed.getSources().get(1));
            assertSourceEquals(Table.class, "even_third_t", parsed.getSources().get(2));
        }
    }
    ...
    class NestedQuery {
        ...
        void oneLevelNestedSource() throws Exception {
            ...
            assertSourceEquals(Query.class, null, source);
            ...
            assertSourceEquals(Table.class, "some_table", nestedQuery.getSources().getFirst());
        }
        ...
        void oneLevelNestedSourceWithAlias() throws Exception {
            ...
            assertEquals(1, parsed.getSources().size());
            final var source = parsed.getSources().getFirst();
            assertSourceEquals(Query.class, "t", source);
            final var nestedQuery = (Query) source;
            assertEquals(1, nestedQuery.getColumns().size());
            assertEquals("*", nestedQuery.getColumns().getFirst().getName());
            assertEquals(1, nestedQuery.getSources().size());
    ...
    private void assertSourceEquals(Class<? extends Aliasable> expectedClass, Object expectedName, Source actual) {
